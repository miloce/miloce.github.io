parcelRequire = function(e, r, t, n) {
    ...
    "Bb20": [function(require, module, exports) {
        ...
        function e() {
            var e = ["一个有趣的灵魂？", "我有故事<br>你有酒吗？", "很高兴遇见你", "当你在凝视着网页的时候<br>网页也正在凝视着你", "苟利国家生死以<br>……", "“我这辈子遇到的聪明人，<br>没有不每天阅读的——没有，<br>一个都没有” <br>——查理 • 芒格", "平凡的日常正奇迹的发生着", "你不能厉害了才开始，<br>而是开始了才厉害。", "不要为了逃避现实在个人爱好上花钱找成就感，<br>自以为的清高小众只会显得你很可怜", "人的欲望就犹如高山滚石一般，<br>一旦开始，<br>将永远无法停下。", "爱，<br>因为宽容才能被看见。", "美，<br>只不过是一瞬间的感觉，<br>只有真实才是永恒的，<br>而真实绝不会美。", "在用尽全力之前不要思考究竟能不能成功", "生活的味道，<br>只有小火慢炖才能品味", "我一点也不孤单，<br>因为我的世界只有我一个人已经足夠热闹了。", "寂寞的人有两种 ，一种是什么话都听的明白，<br>一种是什么话都听不明白。"],
                i = o(0, e.length - 1);
            t("#slogan").html(e[i])
        }
